...
public class myJson {
    ...
    public static String Post(String s ,String[] a, String myKey) throws ExecutionException, InterruptedException {
        ...
        return new DownloadWebpageTask().execute(s,"POST",parameters,myKey).get();
...
// params comes from the execute() call: params[0] is the url.
        ...
        private String downloadUrl(String myurl, String method , String data, String myKey) throws IOException {
            InputStream is = null;
...
//                conn.setRequestProperty("Authorization", myKey);
                conn.setRequestProperty("Authorization", "Bearer 6BKSy6Yd-CiynSsOtawhQIdppxQgpRVs");
